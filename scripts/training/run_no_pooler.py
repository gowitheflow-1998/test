...
def main():
    ...
    if "xnli" not in data_args.dataset_name and "unsup" not in data_args.dataset_name and 'neg' not in data_args.dataset_name and 'span' not in data_args.dataset_name:
        logger.info("Select positive samples only.")
