...
# model_paths = ["model-ablation/msmarco-pixel/checkpoint-4200",
#                "model-ablation/allnli-msmarco-pixel/checkpoint-6600",
#                "model/0-allnli-normed"]
# model_paths = ["model-ablation/msmarco-pixel/checkpoint-4200",
#                "model-ablation/allnli-msmarco-pixel/checkpoint-6600"]
...
for model_path in model_paths:
    ...
    # model_path = "00-allnli-p9-allnli-p9-allnli-p9-allnli-old-best/checkpoint-2600"
    # model_path = "model/0-allnli-normed"
    # model_path = "model/0-unsup-wc-allnli-normed"
    # model_path = "model/0-unsup-ensemble-allnli-normed"
    # model_path = "model/0-unsup-ensemble-wikispan-allnli-normed"
    # # model_path = "Pixel-Linguist/Pixel-Linguist-v0"
    # model_path = "model-ablation/allnli-reasoning-6-pixel/checkpoint-3800"
    # model_path = "model-ablation/msmarco-pixel/checkpoint-4200"
    model = DRES(PixelForRetrieval(model_path=model_path),batch_size=16)
